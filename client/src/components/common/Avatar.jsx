    ...
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          ...
          >
            <div
              className={`z-10 h-60 w-60 bg-photopicker-overlay-background absolute top-0 left-0 flex items-center rounded-full justify-center flex-col text-center gap-2 ${
